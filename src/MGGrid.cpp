...
: nCells_(nCells), meshWidth_(meshWidth), p_(p), rhs_(rhs),
  resVec_({nCells_[0]+2, nCells_[1]+2}, {-.5*meshWidth_[0], -.5*meshWidth_[1]}, meshWidth_)
{};
...
: nCells_({nCells[0]/2, nCells[1]/2}), meshWidth_({meshWidth[0]*2, meshWidth[1]*2}),
  p_({nCells_[0]+2, nCells_[1]+2}, {-.5*meshWidth_[0], -.5*meshWidth_[1]}, meshWidth_),
  resVec_({nCells_[0]+2, nCells_[1]+2}, {-.5*meshWidth_[0], -.5*meshWidth_[1]}, meshWidth_),
  rhs_({nCells_[0]+2, nCells_[1]+2}, {-.5*meshWidth_[0], -.5*meshWidth_[1]}, meshWidth_)
{};
