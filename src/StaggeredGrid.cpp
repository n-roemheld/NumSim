...
void StaggeredGrid::receive_boundary_vertical_u(MPI_Request& current_request, int sender_tag, int j_fixed, int i_begin, int i_end, int source_rank, bool do_nothing)
{
