...
SmootherDJacobi::SmootherDJacobi(int numberOfIterationsPre, int numberOfIterationsPost) :
    Smoother(numberOfIterationsPre, numberOfIterationsPost)
{};

void SmootherDJacobi::presmooth(std::shared_ptr<MGGrid> mgg)
{
...
void SmootherDJacobi::postsmooth(std::shared_ptr<MGGrid> mgg)
{
...
void SmootherDJacobi::smooth(std::shared_ptr<MGGrid> mgg, int numberOfIterations)
{
    std::array<double,2> mW = mgg->meshWidth();
	double dx = mW[0];
	double dy = mW[1];
